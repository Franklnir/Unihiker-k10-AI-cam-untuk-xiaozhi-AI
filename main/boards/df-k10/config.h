...
/* DFRobot K10 TF/MicroSD slot, SPI labels from the official schematic */
#define SD_SPI_GPIO_MOSI GPIO_NUM_42
#define SD_SPI_GPIO_MISO GPIO_NUM_41
#define SD_SPI_GPIO_SCLK GPIO_NUM_44
#define SD_SPI_GPIO_CS   GPIO_NUM_40
